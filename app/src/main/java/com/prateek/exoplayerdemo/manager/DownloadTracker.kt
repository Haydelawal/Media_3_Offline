...
import com.prateek.exoplayerdemo.manager.OfflineVideoDownloadService
import com.prateek.exoplayerdemo.manager.TrackSelectionDialog.Companion.createForTracksAndParameters
import com.prateek.exoplayerdemo.manager.TrackSelectionDialog.Companion.willHaveContent
...
class DownloadTracker(
    ...
    fun toggleDownload(
        ...
        if (download != null && download.state == Download.STATE_DOWNLOADING) {
            Toast.makeText(context, "Downloading Current Item, Please Wait...", Toast.LENGTH_SHORT)
                .show()

//      DownloadService.sendRemoveDownload(
//          context, OfflineVideoDownloadService.class, download.request.id, /* foreground= */ false);
//
        ...
        } else if (download != null && download.state == Download.STATE_COMPLETED) {
    ...
    private inner class StartDownloadDialogHelper(
        ...
        private fun onDownloadPrepared(helper: DownloadHelper) {
            ...
            trackSelectionDialog = createForTracksAndParameters( /* titleId= */
                ...
                allowAdaptiveSelections = false,  /* allowMultipleOverrides= */
