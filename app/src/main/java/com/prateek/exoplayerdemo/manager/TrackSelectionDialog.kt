...
class TrackSelectionDialog : DialogFragment() {
    ...
    companion object {
        ...
        fun createForPlayer(
            ...
            return createForTracksAndParameters(R.string.track_selection_title,
                player.currentTracks,
                player.trackSelectionParameters,  /* allowAdaptiveSelections= */
                allowAdaptiveSelections = true,  /* allowMultipleOverrides= */
                allowMultipleOverrides = false,
                object : TrackSelectionListener {
                    override fun onTracksSelected(trackSelectionParameters: TrackSelectionParameters?) {
                        player.trackSelectionParameters = trackSelectionParameters ?: throw NullPointerException("null track selection params ")
                    }
                },
                onDismissListener
            )
        ...
        fun createForTracksAndParameters(
            ...
            trackSelectionDialog.init(tracks,
